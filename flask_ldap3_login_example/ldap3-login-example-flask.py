...
app.config["LDAP_HOST"] = "ldap://ldap.eng.vmware.com"

# Base DN of your directory
app.config["LDAP_BASE_DN"] = "dc=vmware,dc=com"
...
def manual_login():
    ...
    return str(app.ldap3_login_manager.authenticate("rshende", "nsbu@Vmware16")), 200
